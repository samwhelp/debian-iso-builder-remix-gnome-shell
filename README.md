...
# debian-iso-builder-remix-gnome-shell
...
| Config |
| ------ |
| [~/.config](https://github.com/samwhelp/debian-iso-builder-remix-gnome-shell/tree/main/profile/template/asset/overlay/etc/skel/.config) |
| [/usr/share/glib-2.0/schemas](https://github.com/samwhelp/debian-iso-builder-remix-gnome-shell/tree/main/profile/template/asset/overlay/usr/share/glib-2.0/schemas) |
| [/etc/dconf/db/distro.d](https://github.com/samwhelp/debian-iso-builder-remix-gnome-shell/tree/main/profile/template/asset/overlay/etc/dconf/db/distro.d) |
...
> clone [debian-iso-builder-remix-gnome-shell](https://github.com/samwhelp/debian-iso-builder-remix-gnome-shell)

``` sh
git clone https://github.com/samwhelp/debian-iso-builder-remix-gnome-shell.git
```


> change dir to `debian-iso-builder-remix-gnome-shell`

``` sh
cd debian-iso-builder-remix-gnome-shell
```
...
> change dir to `~/work/debian-iso-builder-remix-gnome-shell/iso-profile`

``` sh
cd ~/work/debian-iso-builder-remix-gnome-shell/iso-profile
```
...
> The resulting ISO file will be placed on `~/work/debian-iso-builder-remix-gnome-shell/iso-profile/dist`
